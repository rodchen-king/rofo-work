          ...
          <div className={styles.root_div_content}>
            <div className="card">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">业务运营平台代码：<a rel="noopener noreferrer" target="_blank" href="http://47.102.40.227/halo-group/halo-frontend">http://47.102.40.227/halo-group/halo-frontend</a></li>
              </ul>
            </div>
            <div className="card">
              <div className="card-header">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">详细内容查看开发规范</li>
              </ul>
            </div>
            <div className="card">
              <div className="card-header">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">详细内容查看代码提交</li>
              </ul>
            </div>
            <div className="card">
              <div className="card-header">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item"><a rel="noopener noreferrer" target="_blank" href="/component">熟悉 业务运营平台代码 代码逻辑</a></li>
                <li className="list-group-item"><span style={{color: 'red'}}>业务运营平台代码 实现商品中心的所有列表数据代码完成 【陈子龙讲解】</span></li>
              </ul>
            </div>
          </div>
        </div>
